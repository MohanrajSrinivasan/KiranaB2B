...
import { Package, ShoppingCart, TrendingUp, Clock, Plus, Minus, Search, Filter } from 'lucide-react';
  ...
  const addToCart = (product, variant, quantity = 1) => {
    ...
    if (existingItem) {
      ...
      setCart([...cart, {
        ...
        price: variant.bulkPrice || variant.price,
        quantity,
        unit: variant.unit,
      ...
      <div className="border-b bg-card">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-foreground">Kirana Dashboard</h1>
        ...
        <Tabs defaultValue="products" className="space-y-6">
                            ...
                            <div key={variant.id} className="flex items-center justify-between p-3 border rounded-lg">
                              <div>
                                ...
                                <div className="flex items-center gap-2">
                                  {variant.bulkPrice && variant.bulkPrice < variant.price ? (
                                    <>
                                ...
                                {variant.minBulkQuantity > 1 && (
                                  <p className="text-xs text-muted-foreground">
                                    Min order: {variant.minBulkQuantity} {variant.unit}
                                  </p>
                                )}
                              </div>
                              <Button
                                onClick={() => addToCart(product, variant, variant.minBulkQuantity || 1)}
          ...
          <TabsContent value="analytics" className="space-y-6">
            <div>
              ...
              <p className="text-muted-foreground">Your ordering patterns and statistics</p>
            </div>
